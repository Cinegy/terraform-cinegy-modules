...
resource "aws_ssm_association" "domain_ssm" {
  name        = data.terraform_remote_state.directoryservice.outputs.directory_service_default_doc_name
...
resource "aws_instance" "vm" {
  ...
  iam_instance_profile = data.terraform_remote_state.directoryservice.outputs.instance_profile_domain_join_name
